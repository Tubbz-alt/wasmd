...
func testnetCmd(ctx *server.Context, cdc *codec.Codec,
	...
	cmd := &cobra.Command{
		Use:   "testnet",
		Short: "Initialize files for a Regend testnet",
...
Example:
	xrnd testnet --v 4 --output-dir ./output --starting-ip-address 192.168.10.2
	`,
	...
	cmd.Flags().String(flagNodeDaemonHome, "xrnd",
		"Home directory of the node's daemon configuration")
	cmd.Flags().String(flagNodeCLIHome, "xrncli",
...
func InitTestnet(
	...
	xrnConfig := srvconfig.DefaultConfig()
	xrnConfig.MinGasPrices = minGasPrices
	...
	for i := 0; i < numValidators; i++ {
		...
		// TODO: Rename config file to server.toml as it's not particular to Regen
		// (REF: https://github.com/cosmos/cosmos-sdk/issues/4125).
		xrnConfigFilePath := filepath.Join(nodeDir, "config/xrnd.toml")
		srvconfig.WriteConfigFile(xrnConfigFilePath, xrnConfig)
	}
