...
// ExportAppStateAndValidators export the state of xrn for a genesis file
func (app *RegenApp) ExportAppStateAndValidators(forZeroHeight bool, jailWhiteList []string,
...
func (app *RegenApp) prepForZeroHeightGenesis(ctx sdk.Context, jailWhiteList []string) {
